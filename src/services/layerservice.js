...
const customLeafletColorPalette = ['0078A8', 'A80000', 'D78E02', 'DCC600', '2CA800', '009EA8', 'A500A8'];
let customLeafletColorId = 0;
function customGetNextColor() {
  let neededColor = customLeafletColorPalette[customLeafletColorId];
  customLeafletColorId++;

  if (customLeafletColorId === customLeafletColorPalette.length) {
